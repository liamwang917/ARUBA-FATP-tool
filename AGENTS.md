...
The approved clean V14.5 template is versioned under `templates/Post-MIC limit_20260911.xlsx`. Legacy DUT / RawData production values were removed. Release SHA-256 = `a556aa066b9412fb17512bb4f992d26909676c5bc53a138616e2cebef2925724`.
...
The approved template is versioned at `templates/Post-MIC limit_20260911.xlsx` and must be bundled with the release/EXE. Normal users never browse for or manually install it.
